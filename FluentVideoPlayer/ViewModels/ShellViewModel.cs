...
namespace FluentVideoPlayer.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<LibraryPage>("Shell_Library".GetLocalized(), Symbol.Video));
            _primaryItems.Add(ShellNavigationItem.FromType<HistoryPage>("Shell_History".GetLocalized(), Symbol.World));
        }
